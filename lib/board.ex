defmodule GameOfLife.Board do
  ...
  def next_board_state(%GameOfLife.Board{} = board) do
    new_alive_cells = MapSet.union(survivor_cells(board), get_newborn_cells(board))
  ...
  def get_dead_neighbours(%GameOfLife.Board{} = board, alive_cell) do
    get_neighbours(alive_cell)
